...
создание долкумента Поступления товаров 
...
* Проверка заполнения таб.часи	
	Тогда таблица "Товары" содержит строки:
		| 'Товар'   | 'Цена'     | 'Артикул' | 'Количество' | 'Сумма'     |
		| 'Bosch15' | '2 700,00' | '*'       | '10,00'      | '27 000,00' |
...
* Спроверка создания докумепнта
	И таблица  "Список" содержит строки:
		| 'Номер'      | 
		| '$НомерДок$' |	

Сценарий: проверка наличия в спр.Номенклатуры "Bosch15"
